  ...
  <div class="flex h-screen bg-gray-100 font-sans">
    ...
    <aside class="hidden md:flex flex-col w-64 bg-crmDark text-white shadow-xl">
      ...
      <div class="flex-1 py-6 px-3 space-y-2">
        <router-link to="/" class="flex items-center px-4 py-3 rounded-lg hover:bg-crmHover transition" active-class="bg-crmPrimary font-bold shadow-lg">
          <span class="mr-3">📊</span> Tableau de bord
        </router-link>
        
        <router-link to="/planning" class="flex items-center px-4 py-3 rounded-lg hover:bg-crmHover transition" active-class="bg-crmPrimary font-bold shadow-lg">
          <span class="mr-3">📅</span> Agenda
        </router-link>
        
        <router-link to="/reservations" class="flex items-center px-4 py-3 rounded-lg hover:bg-crmHover transition" active-class="bg-crmPrimary font-bold shadow-lg">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <header class="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-6 shadow-sm">
        ...
        <div class="flex items-center gap-6">
          ...
          <button @click="handleLogout" class="text-sm font-bold text-red-600 bg-red-50 hover:bg-red-100 px-4 py-2 rounded-lg transition">
            Déconnexion
          </button>
        </div>
